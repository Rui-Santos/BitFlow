class Order < ActiveRecord::Base
  ...
  validates_numericality_of :price, :greater_than => 0.0, :if => proc { |bid| bid.order_type == Type::LIMIT.to_s }
  validates_numericality_of :amount, :greater_than => 0.0
  validates_presence_of :price, :if => proc { |bid| bid.order_type == Type::LIMIT.to_s }
