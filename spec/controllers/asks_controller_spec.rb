  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Ask" do
        expect {
          post :create, :ask => valid_attributes
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested ask" do
        ...
        Ask.any_instance.should_receive(:update_attributes).with({'these' => 'params'})
        put :update, :id => ask.id, :ask => {'these' => 'params'}
      end

      it "assigns the requested ask as @ask" do
        ask = Ask.create! valid_attributes
        put :update, :id => ask.id, :ask => valid_attributes
        assigns(:ask).should eq(ask)
      end
