  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Bid" do
        expect {
          post :create, :bid => valid_attributes
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested bid" do
        ...
        Bid.any_instance.should_receive(:update_attributes).with({'these' => 'params'})
        put :update, :id => bid.id, :bid => {'these' => 'params'}
      end

      it "assigns the requested bid as @bid" do
        bid = Bid.create! valid_attributes
        put :update, :id => bid.id, :bid => valid_attributes
        assigns(:bid).should eq(bid)
      end
